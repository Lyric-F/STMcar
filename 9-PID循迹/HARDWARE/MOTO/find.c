...
int Find(void)
{
	...
	//全是白线，前进
	if((Find_O4 == 0)&&(Find_O3 == 1)&&(Find_O2 == 1)&&(Find_O1 == 0))// 白线，前进
	{
			Find_State = 0;
	}
	////O2在黑线  右边有黑线 小车偏左
	...
	////O1在黑线  右边有黑线 小车偏偏偏左
	//应向右转调整到前进方向	。即左轮加速右轮减速
	else if((Find_O4 == 0)&&(Find_O3 == 0)&&(Find_O2 == 0)&&(Find_O1 == 1))// O1寻到黑线
	{
			Find_State = 5;
	...
	////O1在黑线  右边有黑线 小车偏偏偏左
	//应向右转调整到前进方向	。即左轮加速右轮减速
	else if((Find_O4 == 0)&&(Find_O3 == 1)&&(Find_O2 == 1)&&(Find_O1 == 1))// O1寻到黑线
	{
			Find_State = 4;
	...
	else if((Find_O4 == 0)&&(Find_O3 == 1)&&(Find_O2 == 0)&&(Find_O1 == 0))// O3寻到黑线
	{
			Find_State = -1;
	}
	////O3，O4在黑线  左边边有黑线 小车偏偏右+
	//应向左转调整到前进方向	。即右轮加速左轮减速
	else if((Find_O4 == 1)&&(Find_O3 == 1)&&(Find_O2 == 0)&&(Find_O1 == 0))// O3 O4寻到黑线
	{
			Find_State = -2;
	}
	...
	////O4在黑线  左边边有黑线 小车偏偏偏右
	//应向左转调整到前进方向	。即右轮加速左轮减速
	else if((Find_O4 == 1)&&(Find_O3 == 0)&&(Find_O2 == 0)&&(Find_O1 == 0))// O4寻到黑线
	{
			Find_State = -5;
		...
		////O4在黑线  左边边有黑线 小车偏偏偏右
	//应向左转调整到前进方向	。即右轮加速左轮减速
	else if((Find_O4 == 1)&&(Find_O3 == 1)&&(Find_O2 == 1)&&(Find_O1 == 0))// O4寻到黑线
	{
			Find_State = -4;
